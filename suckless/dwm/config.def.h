...
dwm-noborderselflickerfix-2022042627-d93ff48803f0.diff  ------ no border for single window
dwm-centeredmaster-6.1.diff ------ centeredmaster
dwm-alternativetags-6.3.diff
dwm-focusurgent-20221004-6.3.diff ------ popups
centeredmonocle ------ for ultrawide (custom)
dwm-pertag_with_sel-20231003-9f88553.diff ------ for dedicated layouts
dwm-fakefullscreenclient-6.6 ------- https://github.com/bakkeby/patches/blob/master/dwm/dwm-fakefullscreenclient-6.6.diff
		this had to be hacked for fullscreen plugin compatibility
*/
...
static const double activeopacity   = 1.0;     /* Window opacity when it's focused (0 <= opacity <= 1) */
static const double inactiveopacity = 0.3;     /* Window opacity when it's inactive (0 <= opacity <= 1) */
...
static char dmenufont[]             = 	"Hack Nerd Font Mono:size=14";
static const char *fonts[]          = 	{
		"M+1CodeLat60 Nerd Font Mono:size=14", "monospace:size=10", 
...
static char normfgcolor[]    	=	"#bcb8ba";
static char normbgcolor[]    	=	"#30272b";
static char normbordercolor[]	=	"#30272b";
static char selbordercolor[] 	=	"#f38b58";
static char selfgcolor[]     	=	"#443c40";
static char selbgcolor[]     	=	"#ebac88";
...
static char *colors[][3] = {
       /*               fg           bg           border   */
		...
		[SchemeStatus]  = { normfgcolor, "#000000",  normbgcolor  }, /* status R */
		[SchemeTagsSel]  = { selbordercolor, "#000000",  normbgcolor  }, /* tag L selected */
		[SchemeTagsNorm]  = { normfgcolor, normbgcolor,  normbgcolor  }, /* tag L unselected */
		[SchemeInfoSel]  = { selbordercolor, "#000000",  normbgcolor  }, /* info M selected */
		[SchemeInfoNorm]  = { normfgcolor, normbgcolor,  normbgcolor  }, /* info M unselected */
};


/* tagging */
static const char *tags[] = { "", "2", "󰊯", "4", "5", "6", "7", "󰧮", "" };
...
static const Rule rules[] = {
	...
	{ "fzfmenu",   			 		NULL,    "fzf",			0,			1,          1,           1,       0		 -1 }, /* xev */
	{ NULL,        			 		NULL,    "Event Tester",0,			0,          0,           1,       0		 -1 }, /* xev */
	{ "vscodium",      				NULL,	 NULL,          1,			0,       	 0,           1,      0		  -1 },
	{ "Code",						NULL,	 NULL,          1,			0,       	 0,           1,      0		  -1 },
	{ "firefox-developer-edition",  NULL,    NULL,          1 << 1,		0,       	 0,           1,      0		  -1 },
	{ "qutebrowser",				NULL,    NULL,          1 << 1,		0,       	 0,           1,      0		  -1 },
	{ "Google-chrome",				NULL,    NULL,          1 << 2,		0,       	 0,           1,      1       -1 },
	{ "google-chrome",				NULL,    NULL,          1 << 2,		0,       	 0,           1,      1       -1 },
	{ "Zathura",					NULL,    NULL,          1 << 7,		0,       	 0,           1,      0       -1 },
	{ "mpv", 						NULL,    NULL,          1 << 8,		1,       	 0,       	1,        0     -1 },
	{ "pavucontrol", 				NULL,    NULL,          0,			1,       	 0,       	1,        0     -1 },
	{ "Matplotlib", 				NULL,    NULL,          0,			1,       	 0,       	1,        0     -1 },
	{ NULL, 						NULL,    "floatst",     0,			1,       	 0,       	0,        0     -1 },
	{ "scrcpy", 					NULL,    NULL,     		0,			1,       	 0,       	0,        0     -1 },
	{ "Virt-manager", 				NULL,    NULL,     		0,			1,       	 0,       	0,        0     -1 },
...
static const Layout layouts[] = { /* alt glyphs: 󱡗 󱏋 󰝘  [M] 󰓒 󰇥  󰫣 󰫥*/
...
static const char *termbindcmd[] = { "st", "-T", "floatst", "-g", "80x24", NULL };
static const char *volctl[] = {"pavucontrol"};
...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_n,      spawn,          {.v = termbindcmd } },
	{ MODKEY|ControlMask,           XK_v,      spawn,          {.v = volctl } },
	...
	{ MODKEY|ControlMask,			XK_u,      setlayout,      	{.v = &layouts[5]} }, /* centeredmaster */
	{ MODKEY,                       XK_o,      setlayout,       {.v = &layouts[6]} }, /* centeredfloatingmaster */
	{ MODKEY,                       XK_u,      setlayout,       {.v = &layouts[7]} }, /* centeredmonocle */
...
/* gaps control */
	...
	{ MODKEY|ShiftMask,             XK_minus,  defaultgaps,    {1} },
	{ MODKEY|ShiftMask,             XK_p,      focusurgent,    {0} },
...
/* application bindings */
	...
	// { MODKEY|ControlMask,	XK_n,          spawn,      {.v = (const char*[]){ "st", "-t", "stfloat", NULL } } },
...
/* script launch bindings */
	...
	{ MODKEY|ControlMask,	XK_k,      spawn,       SHCMD("repos-dmenu.sh") },
	{ MODKEY|ControlMask,	XK_l,      spawn,       SHCMD("tmux-dmenu.sh" ) },
	{ MODKEY|ControlMask,	XK_f,  	   spawn,       SHCMD("bookmarks-dmenu.sh") },
	{ MODKEY, XK_comma, spawn, SHCMD("piper-read") },
	// { MODKEY,				XK_F3,     spawn,       {.v = (const char*[]){ "phototransfer", NULL } } },


/* other bindings */
	{ MODKEY,				XK_F8,    spawn,       SHCMD("playerctl -p termusic next") },
	{ MODKEY,				XK_F7,    spawn,       SHCMD("playerctl -p termusic play-pause") },
	{ MODKEY|ShiftMask,		XK_F7,    spawn,       SHCMD("playerctl play-pause") },
	{ MODKEY,				XK_F6,    spawn,       SHCMD("playerctl -p termusic previous") },
	{ MODKEY|ShiftMask,		XK_F5,     spawn,       SHCMD("slock systemctl suspend -i") },
	{ MODKEY,				XK_F5,     spawn,       SHCMD("slock") },
	{ MODKEY,				XK_F3,     spawn,       SHCMD("sb-timer menu") },
	{ MODKEY|ShiftMask,		XK_F3,     spawn,       SHCMD("sb-timer cleanup") },
	{ MODKEY,				XK_F11,     spawn,       SHCMD("wpctl set-volume @DEFAULT_SINK@ 5%+") },
	{ MODKEY,				XK_F10,     spawn,       SHCMD("wpctl set-volume @DEFAULT_SINK@ 5%-") },
	{ MODKEY|ShiftMask,		XK_F11,     spawn,       SHCMD("brightnessctl s +50") },
	{ MODKEY|ShiftMask,		XK_F10,     spawn,       SHCMD("brightnessctl s 50-") },
	{ MODKEY|ControlMask,	XK_F10,     spawn,       SHCMD("ddcutil -l \"LG ULTRAWIDE\" setvcp 10 - 10") },
	{ MODKEY|ControlMask,	XK_F11,     spawn,       SHCMD("ddcutil -l \"LG ULTRAWIDE\" setvcp 10 + 10") },
	{ MODKEY|ControlMask,	XK_m,     spawn,       SHCMD("wpctl set-mute @DEFAULT_SOURCE@ toggle") },
};
